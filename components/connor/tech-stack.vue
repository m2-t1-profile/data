<template>
  <div class="w-full px-1">
    ...
    <div class="flex flex-wrap content-start bg-gray-200">
      ...
      <!-- JS -->
      <div class="w-1/5 p-2 text-center">
        <img class="object-center inline-block w-20 h-20 mr-4" src="/svg/iconfinder_187_Js_logo_logos_4373213.svg"
             alt="javaScript">
      </div>
      <!-- Vue -->
      <div class="w-1/5 p-2 text-center">
    ...
    <div class="flex flex-wrap content-start bg-gray-200">
      ...
      <!-- Nuxt -->
      <div class="w-1/5 p-2 text-center">
        <img class="object-center inline-block w-20 h-20 mr-4" src="/svg/icon-nuxt.svg" alt="Nuxt">
      </div>
      <!-- tailwind -->
      <div class="w-1/5 p-2 text-center">
    ...
    <div class="flex flex-wrap content-start bg-gray-200">
      ...
      <!-- Redis -->
      <div class="w-1/5 p-2 text-center">
        <img class="object-center inline-block w-20 h-20 mr-4" src="/svg/iconfinder_Redis.svg" alt="Redis">
      </div>
    </div>
  </div>
</template>
